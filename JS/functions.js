...
// 		f = "0" + f
// 	}
// 	var a = '<span class="digit">' + g + '</span> dias <span class="digit">' + b + '</span> horas <span class="digit">' + d + '</span> minutos <span class="digit">' + f + "</span> segundos";
// 	$("#elapseClock").html(a)
// }

function timeElapse() {
    var together = new Date(localStorage.getItem('startDate'));
    var e = new Date();
